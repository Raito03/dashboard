...
export default function StudentDashboard() {
  ...
  const [jigyasaCompleteModal, setJigyasaCompleteModal] = useState<boolean>(false);
  ...
  const [pragyaCompleteModal, setPragyaCompleteModal] = useState<boolean>(false);
            ...
            <div className="page-wrapper" style={{ marginLeft: '250px' }}>
                ...
                { title: 'Total Mentors Participated for Mentor Connect Sessions', value: mentorsParticipatedSessionsTotal, icon: <IconUser />, color: 'bg-sky-900',suffix:''},
                        ...
                        <div className="row g-4 mb-4">
                            ...
                            <div className="col-sm-4 col-lg-4" onClick={() => setMissionCompleteModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Mission Completes Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setJigyasaCompleteModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Jigyasa Completes Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setPragyaCompleteModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Pragya Completes Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setMissionCoinModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Mission Coins Earned Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setJigyasaCoinModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Jigyasa Coins Earned Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setPragyaCoinModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-muted">Click to see Pragya Coins Earned Over Time</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 col-lg-4" onClick={() => setCouponRedeemsModal(true)}>
                                <div className="card cursor-pointer hover:shadow-lg transition-shadow">
                                    <div className="card-body">
                                        <div className="d-flex align-items-center">
